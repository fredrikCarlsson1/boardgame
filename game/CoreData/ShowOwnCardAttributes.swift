    ...
    override func viewDidLoad() { 
        ...
        if let gameNr = typeOfGame{
            if (gameNr == 0 || gameNr == 1 || gameNr == 2){
                if (gameNr == 0){
                    labelHeader.text = NSLocalizedString("withOtherWords", comment: "")
                }
                else if (gameNr == 1){
                    labelHeader.text = NSLocalizedString("charades", comment: "")
                }
                else if (gameNr == 2){
                    labelHeader.text = NSLocalizedString("humTheSong", comment: "")
                }
                titleDescriptionLabel.frame = CGRect(x: 0, y: 20, width: 150, height: 30)
                titleDescriptionLabel.text =  NSLocalizedString("titlePlaceholder", comment: "")
                word1DescriptionLabel.frame = CGRect(x: 0, y: 60, width: 70, height: 30)
                word1DescriptionLabel.text =  NSLocalizedString("word1Placeholder", comment: "")
                word2DescriptionLabel.frame = CGRect(x: 0, y: 100, width: 70, height: 30)
                word2DescriptionLabel.text =  NSLocalizedString("word2Placeholder", comment: "")
                word3DescriptionLabel.frame = CGRect(x: 0, y: 140, width: 70, height: 30)
                word3DescriptionLabel.text =  NSLocalizedString("word3Placeholder", comment: "")
                word4DescriptionLabel.frame = CGRect(x: 0, y: 180, width: 70, height: 30)
                word4DescriptionLabel.text =  NSLocalizedString("word4Placeholder", comment: "")
                word5DescriptionLabel.frame = CGRect(x: 0, y: 220, width: 70, height: 30)
                word5DescriptionLabel.text =  NSLocalizedString("word5Placeholder", comment: "")
                ...
                labelHeader.text = NSLocalizedString("teamChallenge", comment: "")
                
                titleDescriptionLabel.frame = CGRect(x: 0, y: 20, width: 150, height: 30)
                titleDescriptionLabel.text =  NSLocalizedString("titlePlaceholder", comment: "")
                word1DescriptionLabel.frame = CGRect(x: 0, y: 60, width: 85, height: 30)
                word1DescriptionLabel.text = NSLocalizedString("challengePlaceholder", comment: "")
                ...
                labelHeader.text = NSLocalizedString("canYouFigureItOut", comment: "")
                
                titleDescriptionLabel.frame = CGRect(x: 0, y: 20, width: 150, height: 30)
                titleDescriptionLabel.text = NSLocalizedString("titlePlaceholder", comment: "")
                word1DescriptionLabel.frame = CGRect(x: 0, y: 90, width: 70, height: 30)
                word1DescriptionLabel.text = NSLocalizedString("hint1Placeholder", comment: "")
                word2DescriptionLabel.frame = CGRect(x: 0, y: 160, width: 70, height: 30)
                word2DescriptionLabel.text = NSLocalizedString("hint2Placeholder", comment: "")
                word3DescriptionLabel.frame = CGRect(x: 0, y: 230, width: 70, height: 30)
                word3DescriptionLabel.text = NSLocalizedString("hint3Placeholder", comment: "")
                word4DescriptionLabel.frame = CGRect(x: 0, y: 300, width: 70, height: 30)
                word4DescriptionLabel.text = NSLocalizedString("hint4Placeholder", comment: "")
                word5DescriptionLabel.frame = CGRect(x: 0, y: 370, width: 70, height: 30)
                word5DescriptionLabel.text = NSLocalizedString("hint5Placeholder", comment: "")
                answerDescriptionLabel.frame = CGRect(x: 0, y: 420, width: 70, height: 30)
                answerDescriptionLabel.text = NSLocalizedString("answerPlaceholder", comment: "")
