 ...
 class ShowOwnQuestions: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var sections = ["With other Words", "Charades", "Hum the Song", "Team Challenge", "Can you figure it out?"]
...
//    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        objectsArray = [Objects(sectionName: "With Other Words", sectionObjects: withOtherWordsList), Objects(sectionName: "Charades", sectionObjects: charadesList), Objects(sectionName: "Hum the Song", sectionObjects: humTheSongList), Objects(sectionName: "Team Challenge", sectionObjects: teamChallengeList), Objects(sectionName: "Can you figure it out?", sectionObjects: canYouFigureItOutList)]
